    ...
    async convertToGLB(objPath, material) {
        try {
            ...
            const optimizationSettings = {
                decimateRatio: 0.1,  // Reduce to 10% (90% reduction)
                simplifyThreshold: 0.02,  // Increased threshold for more aggressive simplification
                maxTextureSize: 512  // Reduced texture size too
            };
            ...
            const options = {
                ...
                maxTextureSize: optimizationSettings.maxTextureSize,
                forceIndices: true,
                embedImages: true
            };
