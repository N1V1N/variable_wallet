...
if (window.crossOriginIsolated) {
    ...
    try {
        ...
        console.log('CPU limiting not supported');
    }
}
...
async function createModelSlide(config) {
    ...
    viewer.setAttribute('environment-intensity', '2');
    ...
    viewer.setAttribute('poster', 'none');
    viewer.setAttribute('preload', 'true');
